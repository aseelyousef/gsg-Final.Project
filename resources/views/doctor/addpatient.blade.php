...
<body>
  <div class="container">
    ...
    @csrf
      ...
      <br>
        <div class="form-group row">
          ...
          <div class="col">
              <input class="form-control" type="tel" placeholder="Telephone" id="example-tel-input" name="phone" required>
          </div>
          <div class="col">
              <input class="form-control" type="tel" placeholder="Alternate phone" id="example-tel-input" name="phone2" required>
          </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <input id="male" type="radio"class="form-control" name="gender"  class="custom-control-input" value="Male" {{ (old('sex') == 'male') ? 'checked' : '' }} >
              Male
          ...
          <div class="form-group col-md-4">
            <label for="inputState">Marital Status</label>
              <select id="inputState" class="form-control" name="Marital">
   ...
   <a href="{{ route("search") }}"  class="btn btn-primary">Search Patients</a>
    </form>
  </div>
