    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/laboratorys" method="post">
                ...
                <br>
                    ...
                    <div class="form-group">
                        <label for="lab">Lab test results</label>
                        <textarea class="form-control" name="lab" id="lab" rows="3"></textarea>
                    </div>
       ...
       <style>
         td{
           color: black;
              ...
              <td style="color: black">{{ $labdata->id }}</td>
